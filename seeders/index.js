...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      'password':'0GJuUVbzUIZL6UT',
      'isDeleted':false,
      'username':'Dejon_Fadel41',
      'email':'Lenora.Leannon@gmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await bcrypt.hash(userToBeInserted.password, 8);
    let user = await userDb.updateOne( { 'username':'Dejon_Fadel41' }, userToBeInserted,  {
      upsert: true,
      new: true
    });
    userToBeInserted = {
      'password':'usEFxPQk3ETPd2u',
      'isDeleted':false,
      'username':'Orville20',
      'email':'Libby44@yahoo.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await bcrypt.hash(userToBeInserted.password, 8);
    let admin = await userDb.updateOne( { 'username':'Orville20' }, userToBeInserted,  {
      upsert: true,
      new: true
    });
