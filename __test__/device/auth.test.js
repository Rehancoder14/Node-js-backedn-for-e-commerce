...
beforeAll(async function (){
  try {
    ...
    const dbInstance = client.db('well_test');
    const user = dbInstance.collection('users');
    insertedUser = await user.insertOne({
      username: 'Henry9',
      password: 'sAImggLQ1iPzmj9',
      email: 'Alyce60@yahoo.com',
      name: 'Roderick Schiller',
      userType: 655,
      mobileNo: '(299) 274-3242',
      resetPasswordLink: {},
      loginRetryLimit: 187,
      loginReactiveTime: '2024-12-18T07:26:11.841Z',
      id: '658ebd516e1cfa0ce618f5ca'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Major.McDermott84',
        'password':'13eBzq1jbwfi6Md',
        'email':'Karlie10@gmail.com',
        'name':'Darren Schaden',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(123) 323-6738',
