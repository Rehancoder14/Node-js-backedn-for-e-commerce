...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Floy49',
      password: 'W6Ew7nXUU3qVyZk',
      email: 'Vergie.Block@yahoo.com',
      name: 'Sheila Russel',
      userType: 909,
      mobileNo: '(285) 094-8350',
      resetPasswordLink: {},
      loginRetryLimit: 95,
      loginReactiveTime: '2024-11-28T11:07:05.820Z',
      id: '658ebd516e1cfa0ce618f5a0'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Jules87',
        'password':'JlQefsQbPp83Vqq',
        'email':'Fae98@yahoo.com',
        'name':'Dr. Loren Ernser',
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'(007) 436-2295',
